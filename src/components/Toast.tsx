...
export const Toast: React.FC<ToastProps> = ({ id, message, type, position, visible }) => {
    ...
    return (
        <div className={`fixed ${positionClass} max-w-96 bg-bg-100 text-text-on-background px-4 py-2 rounded-md z-20 ${toastType} flex flex-col gap-1.5 border drop-shadow-lg`}>
