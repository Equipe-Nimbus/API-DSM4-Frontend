...
export default function Tutorial() {
    return (
        <>
            ...
            <div className="bg-bg-100 p-4 rounded-md drop-shadow">
            <Image src="/sensor-temperatura.webp" alt="station icon" width={99} height={44} /><p className="text-text-on-background text-base font-medium justify-between ml-32">Temperatura:
                    <br />
                    Um sensor de temperatura é um dispositivo que mede a temperatura do ambiente ou
                    de um objeto e 
                    <br />
                    converte essa informação em
                ...
                <p className="text-text-on-background text-base font-medium justify-between">Pressão:
                    ...
                    <br />
                    A pressão atmosférica é a força exercida pelo peso da coluna de ar acima de um
                    ponto específico na superfície da Terra. 
                    <br />
                    Medir essa pressão é crucial em meteorologia
                    porque ela influencia e é influenciada por vários fenômenos climáticos. <Image src="/barometro.jpg" alt="station icon" width={99} height={45} className="ml-auto"/>
                </p>
                <br /><br />
                <Image src="/sensor-umidade.jpg" alt="station icon" width={99} height={44} /><p className="text-text-on-background text-base font-medium justify-between ml-24">Umidade:
                    <br />
                    Um higometro ou sensor de umidade é um instrumento usado para medir a umidade do ar,
                    a medida é normalmente 
                    <br />
                    feita a partir da corrente elétrica de minerais que
                    mudam sua voltagem de acordo com a umidade do ar, 
                    <br />
                    mas também existem métodos
                ...
                <p className="text-text-on-background text-base font-medium justify-between">Velocidade do Vento:
                    ...
                    <br />
                    normalmente medida pela velocidade de rotação de hélices, mas também existe 
                    a medição por temperatura de fios
                    e pulsos ultrassônicos, essa medição é importante para prever e indentificar mudanças e padrões que podem influenciar a
                    formação de outros fenomenos meterológicos. <Image src="/sensor-velocidade-vento.webp" alt="station icon" width={79} height={44} className="ml-auto" />
                </p>
                <br />
                <Image src="/sensor-direcao-vento.jpg" alt="station icon" width={99} height={44} /><p className="text-text-on-background text-base font-medium justify-between ml-32">Direção do Vento:
                    <br />
                    Os sensores de direção de vento medem a movimentação do ar em relação a pontos de referência,
                    como pontos cardeias, 
                    <br />
                    são importantes para entender como o vento influencia as condições locais e regionais,
                ...
                <p className="text-text-on-background text-base font-medium justify-between">Pluviometro:
                    ...
                    <br />
                    precipitação de um lugar em determinado tempo, consiste de um funil, 
                    <br />
                    um mecânismo e um sensor que
                    verifica o movimento do mecânismo, 
                    <br />
                    esses dados são extremamente importantes pois ajudam a entender
                    padrões climaticos e prever eventos extremos e monitorar recursos hidricos. <Image src="/pluviometro.webp" alt="station icon" width={99} height={44} className="ml-auto" />
                </p>
                <br />
