        ...
        <>
            ...
            <div className="bg-bg-100 p-4 rounded-md drop-shadow">
                <div className="flex flex-col gap-5">
                    ...
                    <Link href="/" className="flex gap-2 items-center text-lg text-text-on-background transform transition-all duration-200 hover:-translate-y-1">Alertas por localidade <span><HiArrowNarrowRight size={24} className="text-text-on-background"/></span></Link>
                </div>
            </div>
        </>
    )
